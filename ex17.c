...
{
	int i = 0;
	conn->db->rows = malloc(MAX_ROWS * (2 * sizeof(int) + 2 * sizeof(char) * MAX_DATA));
...
{
	// TODO: decide where to supply max_rows and max_data
	...
	switch(action) {
		case 'c':
			// max_rows and max_data supplied only here
